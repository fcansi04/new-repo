...
console.log(airline.lastIndexOf("u"));
console.log(airline.length);
console.log(airline.slice(5, 10));
const indeks = airline.indexOf("r");
console.log(airline.slice(indeks));

console.log("abcdef".indexOf("c"));
console.log("abcdef".slice(1, 8));
console.log("ferhatcanşi".indexOf("c"));
